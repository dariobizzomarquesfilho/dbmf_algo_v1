...
- Create: `lean_project/data/damodaran_erp.json` (generated by `implied_erp/build_damodaran_erp.py`)
...
- [ ] **Step 1: Generate ERP data into Lean data folder**

The ERP country map is produced by `implied_erp/build_damodaran_erp.py` directly
into `lean_project/data/damodaran_erp.json` (no manual copy needed). Run:
